import { initEnv, inBiliApp, biliBridge, isSupport } from '@bilibili/js-bridge';
...
var isAppSupport = function isAppSupport(methodName) {
  return new Promise(function (resolve, reject) {
    isSupport(methodName).then(function (support) {
      if (support) {
        resolve(1);
      } else {
...
export { addEventListener, openBcut, removeEventListener };
